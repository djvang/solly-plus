 ...
 */
function(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}(this,Datepicker),this.$element=jquery__WEBPACK_IMPORTED_MODULE_0___default()(element),this.element=element,this.options=jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({},DEFAULTS,LANGUAGES[options.language],jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(options)&&options),this.$scrollParent=function(element){var includeHidden=arguments.length>1&&void 0!==arguments[1]&&arguments[1],$element=jquery__WEBPACK_IMPORTED_MODULE_0___default()(element),position=$element.css("position"),excludeStaticParent="absolute"===position,overflowRegex=includeHidden?/auto|scroll|hidden/:/auto|scroll/,scrollParent=$element.parents().filter(function(index,parent){var $parent=jquery__WEBPACK_IMPORTED_MODULE_0___default()(parent);return(!excludeStaticParent||"static"!==$parent.css("position"))&&overflowRegex.test($parent.css("overflow")+$parent.css("overflow-y")+$parent.css("overflow-x"))}).eq(0);return"fixed"!==position&&scrollParent.length?scrollParent:jquery__WEBPACK_IMPORTED_MODULE_0___default()(element.ownerDocument||document)}(element,!0),this.built=!1,this.shown=!1,this.isInput=!1,this.inline=!1,this.initialValue="",this.initialDate=null,this.startDate=null,this.endDate=null,this.init()}var Constructor,protoProps,staticProps;return Constructor=Datepicker,staticProps=[{key:"setDefaults",value:function(){var options=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(DEFAULTS,LANGUAGES[options.language],jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(options)&&options)}}],(protoProps=[{key:"init",value:function(){var $this=this.$element,options=this.options,startDate=options.startDate,endDate=options.endDate,date=options.date;this.$trigger=jquery__WEBPACK_IMPORTED_MODULE_0___default()(options.trigger),this.isInput=$this.is("input")||$this.is("textarea"),this.inline=options.inline&&(options.container||!this.isInput),this.format=function(format){var source=String(format).toLowerCase(),parts=source.match(formatParts);if(!parts||0===parts.length)throw new Error("Invalid date format.");return format={source:source,parts:parts},jquery__WEBPACK_IMPORTED_MODULE_0___default.a.each(parts,function(i,part){switch(part){case"dd":case"d":format.hasDay=!0;break;case"mm":case"m":format.hasMonth=!0;break;case"yyyy":case"yy":format.hasYear=!0}}),format}(options.format);var initialValue=this.getValue();this.initialValue=initialValue,this.oldValue=initialValue,date=this.parseDate(date||initialValue),startDate&&(startDate=this.parseDate(startDate),date.getTime()<startDate.getTime()&&(date=new Date(startDate)),this.startDate=startDate),endDate&&(endDate=this.parseDate(endDate),startDate&&endDate.getTime()<startDate.getTime()&&(endDate=new Date(startDate)),date.getTime()>endDate.getTime()&&(date=new Date(endDate)),this.endDate=endDate),this.date=date,this.viewDate=new Date(date),this.initialDate=new Date(this.date),this.bind(),(options.autoShow||this.inline)&&this.show(),options.autoPick&&this.pick()}},{key:"build",value:function(){if(!this.built){this.built=!0;var $this=this.$element,options=this.options,$picker=jquery__WEBPACK_IMPORTED_MODULE_0___default()(options.template);this.$picker=$picker,this.$week=$picker.find(selectorOf("week")),this.$yearsPicker=$picker.find(selectorOf("years picker")),this.$yearsPrev=$picker.find(selectorOf("years prev")),this.$yearsNext=$picker.find(selectorOf("years next")),this.$yearsCurrent=$picker.find(selectorOf("years current")),this.$years=$picker.find(selectorOf("years")),this.$monthsPicker=$picker.find(selectorOf("months picker")),this.$yearPrev=$picker.find(selectorOf("year prev")),this.$yearNext=$picker.find(selectorOf("year next")),this.$yearCurrent=$picker.find(selectorOf("year current")),this.$months=$picker.find(selectorOf("months")),this.$daysPicker=$picker.find(selectorOf("days picker")),this.$monthPrev=$picker.find(selectorOf("month prev")),this.$monthNext=$picker.find(selectorOf("month next")),this.$monthCurrent=$picker.find(selectorOf("month current")),this.$days=$picker.find(selectorOf("days")),this.inline?jquery__WEBPACK_IMPORTED_MODULE_0___default()(options.container||$this).append($picker.addClass("".concat(NAMESPACE,"-inline"))):(jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.body).append($picker.addClass("".concat(NAMESPACE,"-dropdown"))),$picker.addClass(CLASS_HIDE).css({zIndex:parseInt(options.zIndex,10)})),this.renderWeek()}}},{key:"unbuild",value:function(){this.built&&(this.built=!1,this.$picker.remove())}},{key:"bind",value:function(){var options=this.options,$this=this.$element;jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.show)&&$this.on(EVENT_SHOW,options.show),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.hide)&&$this.on(EVENT_HIDE,options.hide),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.pick)&&$this.on(EVENT_PICK,options.pick),this.isInput&&$this.on(EVENT_KEYUP,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.proxy(this.keyup,this)),this.inline||(options.trigger?this.$trigger.on(EVENT_CLICK,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.proxy(this.toggle,this)):this.isInput?$this.on(EVENT_FOCUS,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.proxy(this.show,this)):$this.on(EVENT_CLICK,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.proxy(this.show,this)))}},{key:"unbind",value:function(){var $this=this.$element,options=this.options;jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.show)&&$this.off(EVENT_SHOW,options.show),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.hide)&&$this.off(EVENT_HIDE,options.hide),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(options.pick)&&$this.off(EVENT_PICK,options.pick),this.isInput&&$this.off(EVENT_KEYUP,this.keyup),this.inline||(options.trigger?this.$trigger.off(EVENT_CLICK,this.toggle):this.isInput?$this.off(EVENT_FOCUS,this.show):$this.off(EVENT_CLICK,this.show))}},{key:"showView",value:function(view){var $yearsPicker=this.$yearsPicker,$monthsPicker=this.$monthsPicker,$daysPicker=this.$daysPicker,format=this.format;if(format.hasYear||format.hasMonth||format.hasDay)switch(Number(view)){case VIEWS_YEARS:$monthsPicker.addClass(CLASS_HIDE),$daysPicker.addClass(CLASS_HIDE),format.hasYear?(this.renderYears(),$yearsPicker.removeClass(CLASS_HIDE),this.place()):this.showView(VIEWS_DAYS);break;case VIEWS_MONTHS:$yearsPicker.addClass(CLASS_HIDE),$daysPicker.addClass(CLASS_HIDE),format.hasMonth?(this.renderMonths(),$monthsPicker.removeClass(CLASS_HIDE),this.place()):this.showView(VIEWS_YEARS);break;default:$yearsPicker.addClass(CLASS_HIDE),$monthsPicker.addClass(CLASS_HIDE),format.hasDay?(this.renderDays(),$daysPicker.removeClass(CLASS_HIDE),this.place()):this.showView(VIEWS_MONTHS)}}},{key:"hideView",value:function(){!this.inline&&this.options.autoHide&&this.hide()}},{key:"place",value:function(){if(!this.inline){var $this=this.$element,options=this.options,$picker=this.$picker,containerWidth=jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).outerWidth(),containerHeight=jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).outerHeight(),elementWidth=$this.outerWidth(),elementHeight=$this.outerHeight(),width=$picker.width(),height=$picker.height(),_$this$offset=$this.offset(),left=_$this$offset.left,top=_$this$offset.top,offset=parseFloat(options.offset),placement=CLASS_TOP_LEFT;isNaN(offset)&&(offset=10),top>height&&top+elementHeight+height>containerHeight?(top-=height+offset,placement=CLASS_BOTTOM_LEFT):top+=elementHeight+offset,left+width>containerWidth&&(left+=elementWidth-width,placement=placement.replace("left","right")),$picker.removeClass(CLASS_PLACEMENTS).addClass(placement).css({top:top,left:left})}}},{key:"trigger",value:function(type,data){var e=jquery__WEBPACK_IMPORTED_MODULE_0___default.a.Event(type,data);return this.$element.trigger(e),e}},{key:"createItem",value:function(data){var options=this.options,itemTag=options.itemTag,item={text:"",view:"",muted:!1,picked:!1,disabled:!1,highlighted:!1},classes=[];return jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(item,data),item.muted&&classes.push(options.mutedClass),item.highlighted&&classes.push(options.highlightedClass),item.picked&&classes.push(options.pickedClass),item.disabled&&classes.push(options.disabledClass),"<".concat(itemTag,' class="').concat(classes.join(" "),'" data-view="').concat(item.view,'">').concat(item.text,"</").concat(itemTag,">")}},{key:"getValue",value:function(){var $this=this.$element;return this.isInput?$this.val():$this.text()}},{key:"setValue",value:function(){var value=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",$this=this.$element;this.isInput?$this.val(value):this.inline&&!this.options.container||$this.text(value)}}])&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Datepicker}();if(jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend&&jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(Datepicker.prototype,render,handlers,methods),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn){var AnotherDatepicker=jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker;jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker=function(option){for(var _len=arguments.length,args=new Array(_len>1?_len-1:0),_key=1;_key<_len;_key++)args[_key-1]=arguments[_key];var result;return this.each(function(i,element){var $element=jquery__WEBPACK_IMPORTED_MODULE_0___default()(element),isDestroy="destroy"===option,datepicker=$element.data(NAMESPACE);if(!datepicker){if(isDestroy)return;var options=jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({},$element.data(),jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isPlainObject(option)&&option);datepicker=new Datepicker(element,options),$element.data(NAMESPACE,datepicker)}if(isString(option)){var fn=datepicker[option];jquery__WEBPACK_IMPORTED_MODULE_0___default.a.isFunction(fn)&&(result=fn.apply(datepicker,args),isDestroy&&$element.removeData(NAMESPACE))}}),isUndefined(result)?this:result},jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker.Constructor=Datepicker,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker.languages=LANGUAGES,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker.setDefaults=Datepicker.setDefaults,jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker.noConflict=function(){return jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.datepicker=AnotherDatepicker,this}}}]);